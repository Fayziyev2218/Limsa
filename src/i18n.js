    ...
    resources: {
      uz: {
        translation: {
          ...
          contacts: "Контактлар",
          footer: "© 2024 Limsa. Барча ҳуқуқлар ҳимояланган.",
          ourprice: "Нархларимиз",
          ouraffordable: "Сиз учун ҳамёнбоп нархдаги веб сайтларимиз",

          "cards": {
            "landing": {
              "title": "Лэндинг саҳифа",
              "description": "Бир саҳифали сайтга Лэндинг Пейж деб айтилади. Ушбу саҳифа оддий ва мижозга керакли маълумотни тақдим этади.",
              "features": [
                "UZ домен",
                "24/7 ҳимоя",
                "3 кунда тайёр",
            ...
            "siteCard": {
              "title": "Сайт-визитка",
              "description": "Бу компаниянинг интернетдаги 'визиткаси'. Сайт компания хизматлари ёки маҳсулотлари ҳақида маълумот беради.",
              "features": [
                "UZ домен",
                "24/7 ҳимоя",
                "3-7 кунда тайёр",
            ...
            "exclusive": {
              "title": "Эксклюзив",
              "description": "Бу веб-сайт сизнинг буюртмангизга асосан яратилади. Сиз хоҳлаган турдаги сайтга буюртма беришингиз мумкин.",
              "features": [
                "UZ домен",
                "24/7 ҳимоя",
                "Тиллар сони — Хоҳишингизга кўра",
                "Юқори даражадаги дизайн"
              ]
            }
          },
          negotiate:"Келишилади",
          order:"Буюртма бериш"
      ...
      en: {
        translation: {
          ...
          contacts: "Contacts",
          footer: "© 2024 Limsa. All rights reserved.",
          ourprice: "Our prices",
          ouraffordable: "Our affordable websites for you",
      ...
      ru: {
        translation: {
          ...
          footer: "© Limsa, 2024. Все права защищены",
          ourprice: "Наши цены",
          ouraffordable: "Наши доступные веб-сайты для вас",
          "cards": {
            "landing": {
              "title": "Лендинг страница",
              "description": "Одностраничный сайт также называют лендингом. Страница проста в использовании и предоставляет клиенту необходимую информацию.",
              "features": [
                "Домен UZ",
                "Защита 24/7",
                "Срок 3 дня",
            ...
            "siteCard": {
              "title": "Сайт-визитка",
              "description": "Это 'визитная карточка' компании в Интернете. Сайт представляет услуги или товары компании посетителям.",
              "features": [
                "Домен UZ",
                "Защита 24/7",
                "Срок 3-7 дней",
            ...
            "exclusive": {
              "title": "Эксклюзив",
              "description": "Этот сайт создается по вашему заказу. Вы можете заказать любой сайт по своему желанию.",
              "features": [
                "Домен UZ",
                "Защита 24/7",
                "Количество языков — по желанию",
